    ...
    page.innerHTML = `
      <div style="max-width:560px;width:100%;">
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:28px">
          <button onclick="document.getElementById('wc-qb-login-page')?.remove();(function(){var btns=Array.from(document.querySelectorAll('button'));var closeBtn=btns.find(function(b){var r=b.getBoundingClientRect();return r.top<80&&r.top>=0&&r.left>280&&b.offsetHeight>0;});if(closeBtn)closeBtn.click();})();window.location.hash='#/';" style="display:flex;align-items:center;justify-content:center;width:32px;height:32px;border-radius:8px;border:1px solid hsl(var(--border));background:hsl(var(--card));cursor:pointer;flex-shrink:0;" title="Back">
